...
export default function Pagination({ page, hasMore, onPage, label = "Página" }) {
  return (
    <nav className="mt-7 flex min-h-12 items-center justify-between gap-3 border-t border-[var(--color-border)] pt-5" aria-label="Paginación">
      ...
      <span className="text-sm font-semibold text-[var(--color-text-muted)]" aria-live="polite">{label} {page}</span>
